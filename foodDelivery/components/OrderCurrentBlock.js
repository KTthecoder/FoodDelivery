...
const OrderCurrentBlock = ({title, image, orderTotal, slug, count, id}) => {
    ...
    return (
        <View className='items-center pb-4' style={{width: '100%', borderBottomWidth: 1, borderColor: '#c9c9c9'}}>
            <View className='flex-row items-center'>
                {/* <Image source={require('../assets/images/pizza.jpg')} style={{width: 80, height: 60}} /> */}
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Cart')} className='bg-blue-500 items-center justify-center py-3 rounded-lg mt-5' style={{width: width * 0.9}}>
                <Text className='text-white text-base' style={{fontFamily: 'Montserrat-Medium'}}>Continue Order</Text>
            </TouchableOpacity>
        </View>
    )
}
